...
pub const POTION_CONTRACT: &str = "bb-potions.testnet";
pub const BURRITO_CONTRACT: &str = "bb-burritos.testnet";
pub const STRWTOKEN_CONTRACT: &str = "bb-strw.testnet";

pub const POTIONHEALTH: &str = "QmeejE25ZeANsLCPDfAhrtfQDeuY837DAYcWCrExKyBadq";
pub const POTIONATTACKS: &str = "QmeDySGtR6YUMSew2tRY848XzKAFCi4PWa3R9veMkcBNG7";
pub const POTIONSHIELDS: &str = "QmTBMQQ37pAjJQEYH3ZkKXi2PDtBHCiuSNMsDyUR2argtm";
...
pub struct Potion {
    ...
    description : String,
    potion_type : String,
    points_increment : String,
    media : String
}

#[derive(Serialize, Deserialize, BorshDeserialize, BorshSerialize, Debug, Clone)]
#[serde(crate = "near_sdk::serde")]
pub struct ExtraPotion {
    potion_type: String,
    points_increment : String
}
    ...
    pub fn init_contract(owner_id: AccountId) -> Self {
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Posiones (Burrito Battle)".to_string(),
